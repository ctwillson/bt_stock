...
class MacdStrategy(bt.Strategy):
    ...
    def next(self):
        ...
        zigzag_buy = (self.dataclose < self.p.valley * 1.03)  and (self.dataclose > self.p.valley)
        zigzag_sell = (self.dataclose < self.p.valley) or (self.dataclose > self.p.lastprice * 1.1)
        ...
        if not self.position:
            ...
            if zigzag_buy:
                ...
                self.p.lastprice = self.dataclose
        else:
